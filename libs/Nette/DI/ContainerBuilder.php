	...
	public function addDefinitions(IDiContainer $container, array $definitions)
	{
		foreach ($definitions as $name => $definition) {
			...
			if (isset($definition['class'])) {
				...
				$factory = create_function('$container', 'extract(NClosureFix::$vars['.NClosureFix::uses(array('class'=>$class,'arguments'=> $arguments,'methods'=> $methods,'expander'=> $expander)).'], EXTR_REFS);
				...
				$factory = create_function('$container', 'extract(NClosureFix::$vars['.NClosureFix::uses(array('arguments'=>$arguments,'expander'=> $expander)).'], EXTR_REFS);
					array_walk_recursive($arguments, $expander);
