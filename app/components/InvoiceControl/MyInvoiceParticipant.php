 ...
 * @version    0.3
 */
class MyInvoiceParticipant extends NObject implements IInvoiceParticipant {
     ...
     */
    public function __construct($name, $street, $houseNumber, $city, $zip, $in, $tin, $accountNumber, $address = NULL) {
        $this->setName($name);
